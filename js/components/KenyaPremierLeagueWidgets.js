...
const KenyaPremierLeagueWidgets = ({ dataHeight = '800px' }) => {
    ...
    return (<div className="kenya-premier-league-widgets" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px' }}>
...
//# sourceMappingURL=KenyaPremierLeagueWidgets.js.map